...
\newcommand\makebanner{
   ...
   \vfill
   \centering
   \includegraphics[width=\paperwidth]{logo.pdf}%
   \vfill
}}}
...
\begin{titlepage}
%~ \AddToShipoutPicture*{\makebanner}
\begin{flushright}
\vspace*{3in}
\bfseries
\sffamily
{\Huge www.molitvoslov.com \\ \large от 2011-05-03 \\ версия 0.1}
\end{flushright}
\end{titlepage}
...
%~ \chapter*{Краткое оглавление}
%~ \input{shortogl}
%~ \nopagebreak\bigskip\bigskip
%~ \begin{center}\includegraphics[width=0.15\textwidth]{uzor_end_2}\end{center}
%~ 
%~ 
%~ {\noparindent
%~ \vspace*{-\headoff}
