...
\newcommand{\mychapterendingX}[1][2.5]{%
...
\newcommand{\mychapterendingz}[1][2.5]{%
    \def\ArgI{{#1}}% first argument
    \mychapterendingRelayZ
}
\newcommand{\mychapterendingRelayZ}[1][0.4]{% second argument
    \nopagebreak\centerline{%
        \raisebox{0pt}[\ArgI\baselineskip][0pt]{%
            \includegraphics[width=#1\textwidth]{\ornamentending}}}
}

\newcommand{\mychapterending}[1][0.4]{% second argument
    \vfill
    {\nopagebreak\centering%
        \includegraphics[width=#1\textwidth]{\ornamentending}\par}%
    \vfill
