...
%\fancyhf{}
%\pagestyle{fancy}
\newcommand\myding{\color{red}\ding{68}}
...
\fancyhead[HL]{\wb{15bp}{15bp}%         Offset (48,-16), found
  \begin{picture}(0,0)(25,-32)%           by trial and error.
    \put(0,0){\myding}%                       Upper left corner
    \multiput(12,0)(12,0){37}{\myding}%       Upper border
    \put(456,0){\myding}%                     Upper right corner
    \multiput(0,-12)(0,-12){56}{\myding}%     Left border
    \put(0,-684){\myding}%                    Lower left corner
    \multiput(12,-684)(12,0){37}{\myding}%    Lower border
    \multiput(456,-12)(0,-12){56}{\myding}%   Right border
    \put(456,-684){\myding}%                  Lower right corner
\end{picture}}}
