...
\newcommand{\mychapterending}[1][uzor_end_3]{\nopagebreak\begin{center}\raisebox{0pt}[1.5\baselineskip][0pt]{
\includegraphics[width=0.4\textwidth]{#1}}\end{center}}
...
% dummy commands to enable compilation in the absence
% of tex4ht
\newcommand\CutAt[1]{}
\newcommand\TocAt[2]{}
...
\nopagebreak\bigskip\bigskip\begin{center}\includegraphics[width=0.20\textwidth]{uzor_end_2}\end{center}
